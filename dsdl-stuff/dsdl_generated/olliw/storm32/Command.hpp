 ...
 *
 * Source file: c:\Users\Olli\Documents\GitHub\ardupilot\modules\uavcan\dsdl\uavcan\olliw\storm32\28302.Command.uavcan
 */

#ifndef UAVCAN_OLLIW_STORM32_COMMAND_HPP_INCLUDED
#define UAVCAN_OLLIW_STORM32_COMMAND_HPP_INCLUDED
...
struct UAVCAN_EXPORT Command_
{
    ...
    {
        return "uavcan.olliw.storm32.Command";
    }
...
{
    ::uavcan::DataTypeSignature signature(0x49874D32ADB9DA75ULL);
...
const ::uavcan::DefaultDataTypeRegistrator< ::uavcan::olliw::storm32::Command > _uavcan_gdtr_registrator_Command;
...
template <>
class UAVCAN_EXPORT YamlStreamer< ::uavcan::olliw::storm32::Command >
{
public:
    template <typename Stream>
    static void stream(Stream& s, ::uavcan::olliw::storm32::Command::ParameterType obj, const int level);
};

template <typename Stream>
void YamlStreamer< ::uavcan::olliw::storm32::Command >::stream(Stream& s, ::uavcan::olliw::storm32::Command::ParameterType obj, const int level)
{
    (void)s;
    (void)obj;
    (void)level;
    ...
    s << "gimbal_id: ";
    YamlStreamer< ::uavcan::olliw::storm32::Command::FieldTypes::gimbal_id >::stream(s, obj.gimbal_id, level + 1);
    s << '\n';
    for (int pos = 0; pos < level; pos++)
    {
        s << "  ";
    ...
    s << "payload: ";
    YamlStreamer< ::uavcan::olliw::storm32::Command::FieldTypes::payload >::stream(s, obj.payload, level + 1);
}
...
template <typename Stream>
inline Stream& operator<<(Stream& s, ::uavcan::olliw::storm32::Command::ParameterType obj)
{
    ::uavcan::YamlStreamer< ::uavcan::olliw::storm32::Command >::stream(s, obj, 0);
    return s;
}
...
#endif // UAVCAN_OLLIW_STORM32_COMMAND_HPP_INCLUDED